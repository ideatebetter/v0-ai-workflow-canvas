          ...
          {[1, 2, 3, 4].map((n) => (
            <button
              ...
              style={{
                ...
                padding: "5px 0",
                borderRadius: 6,
                backgroundColor: count === n ? "var(--app-text-primary)" : "var(--app-bg)",
                border: `1px solid ${count === n ? "var(--app-text-primary)" : "var(--app-canvas-dot)"}`,
                fontSize: 12,
                fontWeight: 500,
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
          ...
          <button
            ...
            style={{
              padding: "6px 14px",
              borderRadius: 6,
              backgroundColor: isGenerating || !prompt.trim() ? "var(--app-canvas-dot)" : "var(--app-text-primary)",
              border: "none",
              fontSize: 12,
              fontWeight: 500,
