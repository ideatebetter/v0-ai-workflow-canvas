  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-4 pb-2">
        ...
        <div className="text-[9px] uppercase tracking-widest mt-1" style={{ color: "#555" }}>capacity load</div>
      </div>

      {/* Load bar */}
      <div className="px-3 pb-2" style={{ borderTop: "1px solid #1e1e1e", paddingTop: 8 }}>
        <div className="h-1 rounded-full overflow-hidden" style={{ backgroundColor: "#ffffff0a" }}>
      ...
      {/* Forecast rows */}
      <div className="px-3 pb-3 space-y-1" style={{ borderTop: "1px solid #1e1e1e", paddingTop: 8 }}>
